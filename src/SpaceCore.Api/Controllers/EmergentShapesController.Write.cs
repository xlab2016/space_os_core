...
{
    public partial class EmergentShapesController
    {
        /// <summary>
        /// Add new emergentShape
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] EmergentShapeDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update emergentShape
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] EmergentShapeDto request)
        {
        ...
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/emergentShapes/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<EmergentShapeDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove emergentShape
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
