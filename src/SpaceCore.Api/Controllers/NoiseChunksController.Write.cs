...
{
    public partial class NoiseChunksController
    {
        /// <summary>
        /// Add new noiseChunk
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] NoiseChunkDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] NoiseChunkDto request)
        {
        ...
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/noiseChunks/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<NoiseChunkDto> patch)
        {
