...
{
    public partial class ProjectedPointsController
    {
        /// <summary>
        /// Add new projectedPoint
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] ProjectedPointDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update projectedPoint
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] ProjectedPointDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch projectedPoint
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/projectedPoints/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<ProjectedPointDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove projectedPoint
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
