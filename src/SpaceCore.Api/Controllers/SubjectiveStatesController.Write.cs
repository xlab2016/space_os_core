...
{
    public partial class SubjectiveStatesController
    {
        /// <summary>
        /// Add new subjectiveState
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] SubjectiveStateDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] SubjectiveStateDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch subjectiveState
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/subjectiveStates/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<SubjectiveStateDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove subjectiveState
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
